...
/// (`AppConfig.useMockData == true`). Bildet alle drei Modul-Typen ab.
enum MockData {
    static let manifest = ModuleManifest(
        ...
        modules: [
            Module(id: "dashboard", type: .native, title: "Dashboard",
                   ...
                   url: nil, provider: nil, homeserver: nil, permissions: nil),
            Module(id: "crm", type: .web, title: "CRM",
                   icon: "person.2.fill", order: 20,
                   url: URL(string: "https://demo.knoio.ai/crm"),
                   provider: nil, homeserver: nil, permissions: ["crm.read"]),
            Module(id: "files", type: .external, title: "Dateien",
                   icon: "folder.fill", order: 30,
                   url: URL(string: "https://cloud.demo.knoio.ai"),
                   provider: .nextcloud, homeserver: nil, permissions: nil),
